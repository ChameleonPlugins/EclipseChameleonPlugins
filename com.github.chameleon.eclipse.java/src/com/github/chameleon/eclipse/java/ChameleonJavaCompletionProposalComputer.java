...
public class ChameleonJavaCompletionProposalComputer extends
	ChameleonCompletionProposalComputer implements
	IJavaCompletionProposalComputer  {

	public ChameleonJavaCompletionProposalComputer(String replacementString,
	...
	public ChameleonJavaCompletionProposalComputer() {
	...
	protected String addExpandedEntry(
		...
		try {
			JavaDocumentInfo docInfo = new JavaDocumentInfo(testing, testingLine, testingOffset);
			docInfo.typedString = typedString;
			JavaCompletionProposalBuilder builder = new JavaCompletionProposalBuilder(
	...
	public DocumentInfo getDocumentInfo() {
		try {
			return new JavaDocumentInfo(testing, testingLine, testingOffset);
		} catch (CoreException e) {
			e.printStackTrace();
		}
		return null;
