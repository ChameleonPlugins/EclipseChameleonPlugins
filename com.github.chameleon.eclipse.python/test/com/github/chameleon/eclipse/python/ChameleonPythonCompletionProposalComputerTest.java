 ...
 *
 */
public class ChameleonPythonCompletionProposalComputerTest {

	ChameleonPythonCompletionProposalComputer computer;
	...
	public void setUp() throws Exception {
		...
		int priority = 0;
		try {
			computer = new ChameleonPythonCompletionProposalComputer(
...
//						expectedReplacementLength, myField.get(proposal));
	...
	public void SystemTestComputer() throws MisconfigurationException,
			IOException {
