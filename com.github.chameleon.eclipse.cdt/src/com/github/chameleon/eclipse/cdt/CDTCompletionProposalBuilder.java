...
public class CDTCompletionProposalBuilder extends CompletionProposalBuilder {

	final String BUNDLE = "com.github.chameleon.eclipse.cdt";
	final static String TARGET_LANGUAGE = "C";
	final String COMMENT_STARTER = "//// ";

	public CDTCompletionProposalBuilder(final String language,
