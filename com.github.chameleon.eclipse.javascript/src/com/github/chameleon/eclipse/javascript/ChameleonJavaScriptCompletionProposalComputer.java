...
import com.github.chameleon.eclipse.javascript.JavaScriptDocumentInfo;
...
public class ChameleonJavaScriptCompletionProposalComputer extends
	ChameleonCompletionProposalComputer implements
	IJavaCompletionProposalComputer  {

	public ChameleonJavaScriptCompletionProposalComputer(String replacementString,
			int replacementOffset, int replacementLength, int cursorPosition,
			int priority) {
		BUNDLE = "com.github.chameleon.eclipse.javascript";
		PROGRAMMING_LANGUAGE = "javascript";
	}
	
	public ChameleonJavaScriptCompletionProposalComputer() {
		System.out.println("ChameleonJavaScriptCompletionProposalComputer()");
	}
	...
	protected String addExpandedEntry(
		...
		try {
			JavaScriptDocumentInfo docInfo = new JavaScriptDocumentInfo(testing, testingLine, testingOffset);
			docInfo.typedString = typedString;
			JavaScriptCompletionProposalBuilder builder = new JavaScriptCompletionProposalBuilder(
	...
	public DocumentInfo getDocumentInfo() {
		try {
			return new JavaScriptDocumentInfo(testing, testingLine, testingOffset);
		} catch (CoreException e) {
			e.printStackTrace();
		}
		return null;
